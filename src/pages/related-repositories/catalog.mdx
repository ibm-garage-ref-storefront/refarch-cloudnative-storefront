...
[Catalog Github Repo](https://github.com/ibm-garage-ref-storefront/catalog-ms-openliberty/blob/master/README.md)

### Project Features

<br/><br/>

- Leverages [MicroProfile](https://microprofile.io/) framework to build a Microservices application.
- Uses [Elasticsearch](https://www.elastic.co/products/elasticsearch) to persist Catalog data to Elasticsearch database.
- Uses [Docker](https://docs.docker.com/) to package application binary and its dependencies.
